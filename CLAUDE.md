# Dravya — Claude Code Instructions

## Project Identity

**Dravya** (Sanskrit: द्रव्य — substance, matter) — Material science engine for AGNOS
...
impetus (collision materials), soorat (PBR from physical properties), kiran/joshua (destructible environments), ushma (thermal expansion)
...
- Material property values must be accurate (verified against engineering handbooks)
